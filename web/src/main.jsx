...
function Login({ onEntrar }) {
  ...
  const atalhos = [["concierge", "Concierge"], ["direcao", "Direção"], ["admin", "Admin"], ["hotelaria", "Hotelaria"], ["nutricao", "Nutrição"], ["manutencao", "Manutenção"], ["limpeza", "Limpeza"], ["enfermagem", "Enfermagem"], ["seguranca", "Segurança"]];
  return (
