...
export default function Paciente() {
  ...
  const acompanhante = quarto.modo === "acompanhante";
  ...
  return (
    <div style={{ maxWidth: 430, margin: "0 auto", minHeight: "100dvh", background: C.fundo, fontFamily: "'Plus Jakarta Sans',system-ui,sans-serif", display: "flex", flexDirection: "column" }}>
      <header style={{ position: "sticky", top: 0, zIndex: 10, background: "#fff", borderBottom: `1px solid ${C.linha}`, padding: "12px 18px" }}>
        <MarcaNatus s={16} />
      </header>
